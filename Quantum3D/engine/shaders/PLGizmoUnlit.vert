...
layout(location = 3) in vec3 inTangent;    // Unused but required for Mesh3D binding
layout(location = 4) in vec3 inBitangent;  // Unused but required for Mesh3D binding
